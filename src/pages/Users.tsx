...
const Users: React.FC = () => {
  ...
  const handleEditUser = async (
    userData: Partial<User> & { addedRoles?: string[]; removedRoles?: string[] }
  ) => {
  ...
  const UserCard = ({ user }: { user: User }) => (
    <Card className="p-2 sm:p-3 hover:shadow-md transition-shadow" padding="sm">
            ...
            >
              ...
              <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-xs sm:text-sm font-medium">
                <div className="flex space-x-1 sm:space-x-2">
                  ...
                  >
                    {user.isActive ? (
                      <UserX className="w-3 sm:w-4 h-3 sm:h-4" />
                    ) : (
        ...
        <div className="p-1 sm:p-3">
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            ...
            <div className="flex gap-2 justify-between">
              <select
                value={
                  activeFilter === undefined ? "" : activeFilter.toString()
                }
                onChange={(e) => {
                  setActiveFilter(
                    e.target.value === ""
                ...
                className="px-2 sm:px-4 py-1 sm:py-2 border border-neutral-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-white text-sm w-full sm:w-auto focus:outline-none focus:ring-2 focus:ring-primary-500"
              >
                ...
                <div>
                  ...
                  <div className="mt-1 sm:mt-2 flex flex-wrap gap-1 sm:gap-2">
                    {selectedUser.roles.map((role) => (
                      <span
                        key={role}
                        className="inline-flex items-center px-2 sm:px-3 py-0.5 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-neutral-100 text-neutral-700 dark:bg-neutral-700 dark:text-neutral-300"
                      >
                        {role}
                      </span>
                    ))}
